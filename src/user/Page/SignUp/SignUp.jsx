    ...
    <div className='bg-[#000] p-[10px] h-full min-h-full'>
      ...
      <div className='w-full max-w-[1180px] bg-[#1B1B1B] mt-[40px] rounded-[10px] m-auto py-[15px] md:py-[40px]'>
        ...
        <div className='pb-[20px] border-b border-[#ffffff14] text-center font-manrope text-white text-[18px]'>
          Already have an account? <Link to="/login" className="text-[#EB3465]">Log in</Link>
        </div>
          ...
          <div className='w-full flex flex-wrap justify-between lg-flex-nowrap'>
            <div className='w-[100%] md:w-[48%] mb-5'>
              ...
              <input type="tel" 
                ...
                placeholder='Enter your number..' className='bg-[#1B1B1B] border border-[#ffffff14] w-full px-5 py-5 rounded-lg text-base text-white' />
            </div>
            ...
            <div className='w-[100%] md:w-[48%] mb-5'>
              ...
              <input type="password"
                ...
                onChange={handleInputs}
                value={data.password}
                placeholder='Enter your password...' className='bg-[#1B1B1B] border border-[#ffffff14] w-full px-5 py-5 rounded-lg text-base text-white' />
            </div>
          </div>
          ...
          <div className='w-full flex flex-wrap justify-between lg-flex-nowrap'>
            ...
            <div className='w-[100%] md:w-[48%] mb-5'>
              ...
              <input type="text"
                ...
                onChange={handleInputs}
                value={data.address}
                placeholder='Enter your address...' className='bg-[#1B1B1B] border border-[#ffffff14] w-full px-5 py-5 rounded-lg text-base text-white' />
            </div>
          </div>
        </div>
