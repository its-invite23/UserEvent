...
export default function Customers() {
  ...
  return (
    <div className="event-container w-[100%] max-w-[1200px] m-auto px-[15px] mb-[50px] lg:mb-[100px] ">
      <h2 className="font-manrope text-center font-[600] text-[30px] md:text-[35px] lg:text-[40px] mb-[30px] text-white leading-[36px] md:leading-[32px] lg:leading-[43px]">Hear from our customers</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {Testinomal?.testimonials.map((testimonial, index) => (
          <div key={index} className="relative bg-[#1B1B1B] text-white p-[15px] md:p-[35px] md:pb-[170px] pb-[170px] rounded-[10px] md:rounded-[20px]">
            <RiDoubleQuotesL size={65} className='text-[#454545]' />

            <h3 className='mt-[20px] mb-[10px] font-manrope font-[700] font-[bold] text-[20px]'>{testimonial?.title}</h3>

            <p className=" mb-4 text-[#A9A4A8]">{testimonial.feedback}</p>
            <div className='absolute bottom-[40px]'>
              <Rating value={testimonial?.rating} className='text-[#FCD53F]' />
