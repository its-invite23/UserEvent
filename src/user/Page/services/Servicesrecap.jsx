          ...
          <div className="px-[20px] py-[20px] lg:px-[40px] lg:py-[40px]">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-[20px] py-[2px] md:py-[20px] ">
              <div className=" rounded-lg">
                ...
                <p className="text-white text-[15px] md:text-[18px] xl:text-[25px]">July 22, 2024</p>
              </div>
              <div className=" rounded-lg">
                <p className="text-[#EB3465]">🗺️ Location:</p>
                <p className="text-white  text-[15px] md:text-[18px] xl:text-[25px]">Paris, 75th district</p>
              </div>
              <div className=" rounded-lg">
                <p className="text-[#EB3465]">🥳 Event Type:</p>
                <p className="text-white  text-[15px] md:text-[18px] xl:text-[25px]">Casual party</p>
              </div>
              <div className=" rounded-lg">
                <p className="text-[#EB3465]">👥 Number of Attendees:</p>
                <p className="text-white  text-[15px] md:text-[18px] xl:text-[25px]">10</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2  md:grid-cols-2 lg:grid-cols-3 gap-[20px] py-[10px] md:py-[20px]">
              <div className=" rounded-lg">
                ...
                <p className="text-white  text-[15px] md:text-[18px] xl:text-[25px]">Burger, Italian</p>
              </div>
              <div className=" rounded-lg">
                <p className="text-[#EB3465]">💵 Budget:</p>
                <p className="text-white  text-[15px] md:text-[18px] xl:text-[25px]">$100-$200</p>
              </div>
              <div className=" rounded-lg">
                <p className="text-[#EB3465]">🎳 Activity:</p>
                <p className="text-white  text-[15px] md:text-[18px] xl:text-[25px]">Bowling, DJ</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2  md:grid-cols-2 lg:grid-cols-2 gap-[20px] py-[2px] md:py-[20px]">
              ...
              <div className=" rounded-lg">
                ...
                <p className="text-white  text-[15px] md:text-[18px] xl:text-[25px]">Example@gmail.com</p>
              </div>
            </div>
