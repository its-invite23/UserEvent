        ...
        <div className="relative mt-[30px] md:mt-[40px] lg:mt-[60px] xl:mt-[100px]">
          <div className="flex flex-wrap xl:flex-nowrap xl:block">
            <div className="flex flex-wrap md:flex-nowrap max-w-[1430px] px-[15px] m-auto">
              <div className="max-w-[600px] lg:max-w-[500px] xl:max-w-[600px] pt-[10px] md:pt-[5px] lg:pt-[50px] xl:pt-[100px] ">
                <h2 className="mb-[30px] text-[2em] leading-[1.2em] md:text-[2.5em] md:leading-[1.1em] lg:text-[4em] lg:leading-[1.0em]  xl:text-[6em] xl:leading-[1.1em] text-white  font-[700] text-center md:text-left">
          ...
          <div className="max-w-[1400px] m-auto mt-[50px] md:mt-[150px]">
            <div className="flex items-center flex-wrap md:flex-nowrap mb-[40px] mb-[50px] md:mb-[80px] lg:mb-[150px] flex-row-reverse">
              <div className="max-w-[100%] md:max-w-[50%] mt-[10px]  md:mt-[0] p-[0] sm:p-[20px]">
            ...
            <div className=" flex items-center flex-wrap md:flex-nowrap flex-row-reverse mb-[40px] mb-[50px] md:mb-[80px] lg:mb-[150px]">
              <div className="max-w-[100%] md:max-w-[50%] p-[20px]">
            ...
            <div className="flex flex-wrap items-start gap-[20px] md:gap-[40px]">
          ...
          <div className="max-w-[1400px] m-auto mt-[50px] md:mt-[150px]">
            ...
            <div className="w-full max-w-[800px] m-auto">
              <h2 className="mb-[15px] text-white text-[1.3em] md:text-[1.8em] font-[700] text-center md:text-left">
                Secure your spot with us
              </h2>
              <p class="mb-[40px] text-[#ffffff80] text-[1.1em] md:text-[1.4em] font-[400] text-center md:text-left">
