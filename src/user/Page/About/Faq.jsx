          ...
          {faqData.map((item, index) => (
            ...
            >
              ...
              >
                ...
                <svg width="34" height="34" className={`text-[20px] md:text-[40px] absolute top-[0] bottom-[0] m-auto right-[10px] w-[18px] h-[18px] sm:w-[20px] sm:h-[20px]  md:w-[34px] lg:h-[34px] transition-transform ${activeIndex === index ? "rotate-[45deg]" : ""}`} viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
